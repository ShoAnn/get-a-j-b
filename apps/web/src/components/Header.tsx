      ...
      <header className="sticky top-0 z-40 border-b border-zinc-200 bg-white/80 backdrop-blur-md dark:border-[#333355] dark:bg-[#1A1A2E]/80">
        <div className="mx-auto flex h-14 max-w-7xl items-center gap-4 px-4 sm:px-6 lg:px-8">
          ...
          <button
            ...
            className="ml-auto flex shrink-0 items-center gap-1.5 rounded-lg bg-violet px-4 py-[7px] text-sm font-medium text-white transition-colors hover:bg-[#6B63C9] active:bg-[#5A52B8]"
          >
